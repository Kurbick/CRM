...
class CompanyActivityTest extends TestCase
{
    ...
    public function test_company_show_keeps_contacts_as_default_activity_is_last_and_empty_state_is_exact(): void
    {
        ...
        $response->assertSee('Событий пока нет.')
            ...
            ->assertSee('class="flex h-9 w-full items-center gap-2 px-2 text-left text-sm text-gray-600 outline-none transition hover:text-blue-600 focus:outline-none"', false)
            ...
            ->assertSee('class="mx-2 border-t border-gray-100"', false)
