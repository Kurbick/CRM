...
@section('content')
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 mt-1">Создание нового профиля контрагента</p>
    </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="type" id="type" required
                                ...
                                <option value="company" {{ old('type') === 'company' ? 'selected' : '' }}>Юридическое лицо</option>
                                <option value="individual" {{ old('type') === 'individual' ? 'selected' : '' }}>Индивидуальный предприниматель</option>
                            </select>
                            @error('type')
                        ...
                        <div>
                            ...
                            <input type="text" name="voen" id="voen" value="{{ old('voen') }}"
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="legal_address" id="legal_address" value="{{ old('legal_address') }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="actual_address" id="actual_address" value="{{ old('actual_address') }}"
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="bank_voen" class="block text-xs font-semibold text-gray-500 uppercase mb-1">VÖEN Банка</label>
                            <input type="text" name="bank_voen" id="bank_voen" value="{{ old('bank_voen') }}"
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="status" id="status" required
                                ...
                                <option value="suspended" {{ old('status') === 'suspended' ? 'selected' : '' }}>Приостановлен</option>
